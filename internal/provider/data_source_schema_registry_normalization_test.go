...
func TestSchemaRegistryNormalizationDataSourceReadProviderMigration111To121Setup(t *testing.T) {
...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("data.foxcon_schema_registry_normalization.test", "normalization_enabled", "false"),
					resource.TestCheckNoResourceAttr("data.foxcon_schema_registry_normalization.test", "rest_endpoint"),
				),
			},
		},
	})
